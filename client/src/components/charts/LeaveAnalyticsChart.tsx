...
import { useLeaveAnalytics } from '../../hooks/useAnalytics';
import { ChartSkeleton } from '../ui/ChartSkeleton';

const COLORS = ['#ef4444', '#f59e0b', '#3b82f6', '#ec4899', '#10b981', '#8b5cf6'];

export const LeaveAnalyticsChart = () => {
  const { data, isLoading, isError } = useLeaveAnalytics();
